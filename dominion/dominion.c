...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      ...
      return goAdventurer(state, z, drawntreasure, cardDrawn, temphand[MAX_HAND],currentPlayer);

    case council_room:
      return goCouncil_Room(state, handPos, currentPlayer);

    case feast:
      return goFeast(state, choice1, currentPlayer, temphand[MAX_HAND]);
    ...
    case smithy:
      ...
      return goSmithy(state, handPos, currentPlayer);

    case village:
      return goVillage(state, handPos, currentPlayer);
...
int goCouncil_Room(struct gameState *state, int handPos, int currentPlayer){
...
int goFeast(struct gameState *state, int choice1, int currentPlayer, int temphand[MAX_HAND]){
...
int goVillage(struct gameState *state, int handPos, int currentPlayer){
